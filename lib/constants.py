...
ouiSync_tasks_status_pending = 0
ouiSync_tasks_status_assigned = 1
ouiSync_tasks_status_assignedPending = 2
ouiSync_tasks_status_running = 3
ouiSync_tasks_status_done = 4
ouiSync_tasks_status_failed = 5
